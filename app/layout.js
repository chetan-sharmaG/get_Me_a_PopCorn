...
export default function RootLayout({ children }) {
  ...
  return (
    <html lang="en">
      <body suppressHydrationWarning={true} className="bg-slate-950 bg-[linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f2e_1px,transparent_1px)] bg-[size:14px_24px] overflow-x-hidden">
        <SessionWrapper>
          <Navbar />
