        ...
        <>
            ...
            <div className='flex'>
                <div className='w-[60vw] mx-auto flex flex-col justify-evenly gap-10 mt-10 mb-20'>
                    ...
                    <div className='flex flex-col gap-3'>
                        <h1 className='text-4xl'>Fan or Creator? Why Not Both?</h1>
                        <p>
                            At Popcorn, we celebrate versatility. If you're a creator with a fan spirit or a fan with a hidden creator within, you can effortlessly switch roles. Just sign in, choose your part for the day, and voila! You're all set to explore or be explored.
                        </p>
                    </div>
                    <div className='flex flex-col gap-3'>
                        <h1 className='text-4xl'>Privacy is our Priority</h1>
                        <p>
                        We understand the significance of privacy and respect it wholeheartedly. Each user's personal details are securely locked away and never shared with anyone. Because let's face it, no one likes it when someone else reaches into their popcorn bucket, right?
                        </p>
                    </div>
                    <div className='flex flex-col gap-3'>
                        <h1 className='text-4xl'>Why Wait? The Popcorn World Awaits!</h1>
                        <p>
                        The stage is set, the popcorn is popping, and all we need is you! Whether you're an artist, a fan, or a bit of both, there's a cozy spot for you here at Popcorn. Join us and let's pop together in this journey of creativity, appreciation, and lots of popcorn!
                        </p>
                    </div>
