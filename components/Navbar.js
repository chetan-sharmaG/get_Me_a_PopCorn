...
const Navbar = (props) => {
  ...
  // }
  return (
    <nav className={`${props.color.bg} ${props.color.text} text-white flex  fixed top-0 w-[100%] z-30 justify-between h-[8vh] items-center px-4`}>
          ...
          <>
            ...
            <div id="dropdown" className={`z-10 absolute top-[6vh] ${showdropdown ? "" : "hidden"} bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700`}>
              ...
              <Link href="/dashboard" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Dashboard</Link>
                ...
                <li onClick={() => log("pages")}>
                  <Link href={`/${session.user.pageName}`} className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Your Page</Link>
                </li>
                <li>
